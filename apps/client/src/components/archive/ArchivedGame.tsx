        ...
        <div className="relative h-60 w-full min-w-fit">
          <div className="flex h-full w-full min-w-[64px] flex-col rounded-lg bg-base-300 p-4 shadow-sm">
            ...
            <div className="mt-2 flex items-center justify-end">
              <button
                className={
                  "btn-sm btn rounded-b-none rounded-tr-none normal-case" +
                  (showPgn ? " btn-primary" : "")
                }
              ...
              <div
                className="tooltip"
                data-tip="Current board position is shown."
              >
                <button
                  className={
                    "btn-sm btn rounded-b-none rounded-tl-none normal-case" +
                    (showPgn ? "" : " btn-primary")
                  }
